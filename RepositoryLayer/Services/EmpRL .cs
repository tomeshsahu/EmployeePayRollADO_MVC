...
namespace RepositoryLayer.Services
{
    public class EmpRL : IEmpRL
    {
        ...
        {
            connectionString = configuartion.GetConnectionString("EmployeePayroll_ADO");
        }
        public void AddEmployee(EmployeeModel employee)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    cmd.Parameters.AddWithValue("@ProfileImage", employee.PImage);
                    cmd.Parameters.AddWithValue("@Gender", employee.Gender);
                    cmd.Parameters.AddWithValue("@Department", employee.Dept);
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    while (rdr.Read())
                    {
                        ...
                        employee.PImage = Convert.ToString(rdr["ProfileImage"]);
                        employee.Gender = Convert.ToString(rdr["Gender"]);
                        employee.Dept = Convert.ToString(rdr["Department"]);
